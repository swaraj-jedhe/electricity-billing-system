            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 signup">
                        ...
                        <p><b>Electricity Billing System</b> is made to keep the records of the bills of the customers. The admin can manage all the accounts and the registered users like employees and customers can only manage their accounts. This system helps in maintaining the bills and the 	payments.</p>
                    </div>
                    <!-- /col-lg-6 -->
                    <div class="col-lg-6">
                        <h1>Sign Up</h1>
